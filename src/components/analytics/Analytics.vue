<template>
    <div :style="{ boxShadow: '3px 0px 4px #000000', width: 'fit-content' }"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            :class="chartType === 'table' ? 'text-white' : 'text-secondary'" @click="chartType = 'table'"
        ...
        <svg xml ns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            :class="chartType === 'doughnut' ? 'text-white' : 'text-secondary'" @click="handleClick('doughnut')"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            :class="chartType === 'bar' ? 'text-white' : 'text-secondary'" @click="handleClick('bar')"
    ...
    <div
        ...
        <TableAnalytics v-if="chartType === 'table'" />
        <ChartAnalytics v-else-if="chartType === 'doughnut'" :activeMode="activeMode" />
        <ChartAnalytics v-else :activeMode="activeMode" />
    </div>
</template>
...
const chartType = ref(useRoute().name === 'profile' ? 'bar' : 'doughnut');
const activeMode = ref({ chartType: useRoute().name === 'profile' ? 'bar' : 'doughnut' });
